...
class EcoreExecutableExtensionFactory extends AbstractGuiceAwareExecutableExtensionFactory {
	...
	override protected getInjector() {
		StepActivatorEx.instance.getInjector(LanguageConstants.EXPRESS_ECORE)
	}
