package org.emoflon.ibex.tgg.run.expressemf;
...
public class MODELGEN_App extends MODELGEN {
	...
	public static void main(String[] args) throws IOException {
		...
		stop.setMaxRuleCount("SchemaToPackage", 1); // this should be a rule condition, because we have constraint Express to one schema
		stop.setMaxRuleCount("EntityToClass", 10);
		stop.setMaxRuleCount("SuperTypeToSuperType", 10);
		stop.setTimeOutInMS(3000);
