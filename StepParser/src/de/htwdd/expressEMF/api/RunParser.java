...
import de.htwdd.expressEMF.StepStandaloneSetup;
import de.htwdd.expressEMF.step.ExchangeFile;
...
public class RunParser {
	...
	public Optional<ExchangeFile> parse() {
		...
		if (issues.isEmpty()) return Optional.of((de.htwdd.expressEMF.step.ExchangeFile) resource.getContents().get(0));
	...
	public static void main(String[] args) {
		...
		ExchangeFile stepFile = parser.parse().get();
		parser.saveXmi();
